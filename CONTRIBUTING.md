...
Contributions to **FlorianWolters\Component\Core\Enum** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Core\Enum**:

    md Enum && cd Enum
    git clone git://github.com/FlorianWolters/PHP-Component-Core-Enum.git
